//Autosplitter for version 2.0.5 of ePSXe.

state("ePSXe")
{
	/*-----Pursuit Mode-----*/
	//Bit field for the missions completed (Any%) and commendations earned (100%).
	uint missionsComplete : "ePSXe.exe", 0xB7E0E0;
	uint commendationsEarned : "ePSXe.exe", 0xB7E0CC;
	...
	uint endButtonPressed : "ePSXe.exe", 0xB8E920;
	
	
	/*-----Patrol Mode-----*/
	//Number of criminals caught.
	uint numCriminals : "ePSXe.exe", 0xBBAC5C;
	...
	uint carSelected : "ePSXe.exe", 0xBBAC88;
}
